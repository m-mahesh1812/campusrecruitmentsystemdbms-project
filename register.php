      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
              ...
              <label style="font-size: 18px;">School Percentage/CGPA </label>
              <div>
                <input style="border:1px solid black; border-radius: 5px; width: 80%; height: 45px; padding: 15px; font-size: 18px;" type="text" id="CGPA" name="CGPA" placeholder="CGPA*" required>
              </div>
          ...
          <div class="col-md-6">             
              ...
              <label style="font-size: 18px;"> Pre-Univeristy CGPA </label>
              <div>
                <input style="border:1px solid black; border-radius: 5px; width: 80%; height: 45px; padding: 15px; font-size: 18px;" type="text" id="CGPA" name="CGPA" placeholder="CGPA*" required>
              </div>
              <label style="font-size: 18px;"> Degree CGPA </label>
              <div>
                <input style="border:1px solid black; border-radius: 5px; width: 80%; height: 45px; padding: 15px; font-size: 18px;" type="text" id="CGPA" name="CGPA" placeholder="CGPA*" required>
              </div>
